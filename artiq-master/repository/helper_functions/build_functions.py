...
def load_optimizer_parameters(self):
    ...
    my_setattr(self, 'tolerance',       NumberValue(default=1e-3,unit='',scale=1,ndecimals=6,step=1e-6), scanable=False)
    my_setattr(self, 'converge_count',  NumberValue(default=3,unit='',scale=1,ndecimals=0,step=1), scanable=False)
    my_setattr(self, 'n_candidate_run', NumberValue(default=1024,unit='',scale=1,ndecimals=0,step=1), scanable=False)
    my_setattr(self, 'n_candidate_anal',NumberValue(default=4096,unit='',scale=1,ndecimals=0,step=1), scanable=False)
    my_setattr(self, 'min_Ex',          NumberValue(default=-0.25,unit='',scale=1,ndecimals=3,step=.001), scanable=False)          # Lower bound of Ex
    my_setattr(self, 'max_Ex',          NumberValue(default=0.05,unit='',scale=1,ndecimals=3,step=.001), scanable=False)          # Upper bound of Ex
    my_setattr(self, 'min_Ey',          NumberValue(default=-0.05,unit='',scale=1,ndecimals=3,step=.001), scanable=False)          # Lower bound of Ey
    my_setattr(self, 'max_Ey',          NumberValue(default=0.2,unit='',scale=1,ndecimals=3,step=.001), scanable=False)          # Upper bound of Ey
    my_setattr(self, 'min_Ez',          NumberValue(default=-0.1,unit='',scale=1,ndecimals=3,step=.001), scanable=False)          # Lower bound of Ez
    my_setattr(self, 'max_Ez',          NumberValue(default=0.1,unit='',scale=1,ndecimals=3,step=.001), scanable=False)          # Upper bound of Ez
